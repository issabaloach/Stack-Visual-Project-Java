...
public class MainPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(stack7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 110, 40));
        ...
        pushbtn.setFont(new java.awt.Font("Copperplate Gothic Light", 1, 11)); // NOI18N
        ...
        popbtn.setFont(new java.awt.Font("Copperplate Gothic Light", 1, 11)); // NOI18N
        popbtn.setText("POP");
        ...
        refreshbtn.setFont(new java.awt.Font("Copperplate Gothic Bold", 0, 11)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(popbtn, javax.swing.GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE))
                .addGap(124, 124, 124))
        );
...
// TODO add your handling code here:
    ...
    i = 0;
    stack1.setText("");
    stack1.setBorder(BorderFactory.createMatteBorder(0, 0, 0, 0, Color.BLACK));
    for (int j = 1; j < 8; j++) {
        labels.get(j).setText("");
        topLabels.get(j).setVisible(false);
    }
    if(stack.isEmpty()){
        JOptionPane.showMessageDialog(this, "Stack is empty!", "Stack Empty", JOptionPane.INFORMATION_MESSAGE);
    }else{
        JOptionPane.showMessageDialog(this, "Stack underflow!", "Stack Underflow", JOptionPane.INFORMATION_MESSAGE);
    }
